...
// MultiLevelWriter is an Writer that metalog to different writers by different levels
...
// MultiEntryWriter is an array Writer that metalog to different writers
...
// MultiIOWriter is an array io.Writer that metalog to different writers
